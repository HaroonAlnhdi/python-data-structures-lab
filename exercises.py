...
def slice_foods():
    foods =("burger", "pizza", "pasta", "chicken", "beef")

    # slice(start, stop, step)
    slices = slice(-2, None) # start from the second last element to the end
    last_two_foods = foods[slices]
